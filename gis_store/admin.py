...
from .models import (
    ThuongHieu, NhaCungCap, NhomSanPham, SanPham,
    ChuoiCuaHang, CuaHang, NhanVien, KhuyenMai
)

# -------------------------
# Helpers: image thumbnail (safe)
# -------------------------
...
def _img(field_file, size: int = 42, media_fallback: str | None = None):
    ...
    # fallback chỉ dùng khi được truyền vào (NHÂN VIÊN)
...
class NhanVienAdmin(admin.ModelAdmin):
    ...
    def avatar_thumb(self, obj):
        return _img(
            obj.avatar,
            size=40,
            media_fallback="avatar/default.png"  
        )
